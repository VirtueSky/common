...
namespace Lean.Touch
{
	...
	public class LeanMouseWheel : MonoBehaviour
	{
		...
		public int RequiredMouseButton { set { requiredMouseButton = value; } get { return requiredMouseButton; } } [SerializeField] private int requiredMouseButton = -1;
		...
		public float Multiplier { set { multiplier = value; } get { return multiplier; } } [SerializeField] private float multiplier = 0.1f;
		...
		protected virtual void Update()
		{
			...
			if (requiredMouseButton >= 0 && CwInput.GetMouseIsHeld(requiredMouseButton) == false)
			{
				return;
			}

			var finalDelta = CwInput.GetMouseWheelDelta();
...
namespace Lean.Touch.Editor
{
	...
	public class LeanMouseWheel_Editor : CwEditor
	{
