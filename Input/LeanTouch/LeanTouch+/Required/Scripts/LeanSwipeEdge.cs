...
namespace Lean.Touch
{
	...
	public class LeanSwipeEdge : MonoBehaviour
	{
		...
		public bool Left { set { left = value; } get { return left; } } [SerializeField] private bool left = true;

		/// <summary>Detect swipes coming from the right edge?</summary>
		public bool Right { set { right = value; } get { return right; } } [SerializeField] private bool right = true;

		/// <summary>Detect swipes coming from the bottom edge?</summary>
		public bool Bottom { set { bottom = value; } get { return bottom; } } [SerializeField] private bool bottom = true;

		/// <summary>Detect swipes coming from the top edge?</summary>
		public bool Top { set { top = value; } get { return top; } } [SerializeField] private bool top = true;

		/// <summary>If the swipe angle is off by this many degrees, it will be ignored.
		/// 0 = Must be exactly parallel.</summary>
		public float AngleThreshold { set { angleThreshold = value; } get { return angleThreshold; } } [SerializeField] [Range(1.0f, 90.0f)] private float angleThreshold = 10.0f;

		/// <summary>The swipe must begin within this many scaled pixels of the edge of the screen.</summary>
		public float EdgeThreshold { set { edgeThreshold = value; } get { return edgeThreshold; } } [SerializeField] private float edgeThreshold = 10.0f;
...
namespace Lean.Touch.Editor
{
	...
	public class LeanSwipeEdge_Editor : CwEditor
	{
