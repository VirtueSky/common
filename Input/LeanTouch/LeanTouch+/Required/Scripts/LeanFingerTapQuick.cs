...
namespace Lean.Touch
{
	...
	public class LeanFingerTapQuick : MonoBehaviour
	{
		...
		public int RequiredTapCount { set { requiredTapCount = value; } get { return requiredTapCount; } } [SerializeField] private int requiredTapCount = 1;
...
namespace Lean.Touch.Editor
{
	...
	public class LeanFingerTapQuick_Editor : CwEditor
	{
