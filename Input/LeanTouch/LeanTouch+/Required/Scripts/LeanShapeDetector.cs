...
namespace Lean.Touch
{
	...
	public class LeanShapeDetector : MonoBehaviour
	{
		...
		public LeanShape Shape { set { shape = value; } get { return shape; } } [SerializeField] private LeanShape shape;

		/// <summary>The finger must move at least this many scaled pixels for it to record a new point.</summary>
		public float StepThreshold { set { stepThreshold = value; } get { return stepThreshold; } } [SerializeField] private float stepThreshold = 1.0f;
		...
		public float DistanceThreshold { set { distanceThreshold = value; } get { return distanceThreshold; } } [SerializeField] private float distanceThreshold = 1.0f;
		...
		public float ErrorThreshold { set { errorThreshold = value; } get { return errorThreshold; } } [SerializeField] private float errorThreshold = 1.0f;
		...
		public int MinimumPoints { set { minimumPoints = value; } get { return minimumPoints; } } [SerializeField] private int minimumPoints = -1;

		/// <summary>Which direction should the shape be checked using?</summary>
		public DirectionType Direction { set { direction = value; } get { return direction; } } [SerializeField] private DirectionType direction = DirectionType.ForwardAndBackward;
...
namespace Lean.Touch.Editor
{
	...
	public class LeanShapeDetector_Editor : CwEditor
	{
