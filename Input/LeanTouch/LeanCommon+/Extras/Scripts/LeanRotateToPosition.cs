...
namespace Virtuesky.Lean.Common
{
	...
	[AddComponentMenu(LeanCommon.ComponentPathPrefix + "Rotate To Position")]
	public class LeanRotateToPosition : MonoBehaviour
	{
		...
		public PositionType Position { set { position = value; } get { return position; } } [SerializeField] private PositionType position;
...
namespace Virtuesky.Lean.Common.Editor
{
	...
	public class LeanRotateToPosition_Editor : CwEditor
	{
