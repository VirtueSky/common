...
namespace Virtuesky.Lean.Common
{
	...
	[ExecuteInEditMode]
	[HelpURL(LeanCommon.PlusHelpUrlPrefix + "LeanMaintainDistance")]
	[AddComponentMenu(LeanCommon.ComponentPathPrefix + "Maintain Distance")]
	public class LeanMaintainDistance : MonoBehaviour
	{
		...
		public Space DirectionSpace { set { directionSpace = value; } get { return directionSpace; } } [SerializeField] private Space directionSpace = Space.Self;

		/// <summary>The distance we want to be from the parent in world space.</summary>
		public float Distance { set { distance = value; } get { return distance; } } [SerializeField] private float distance = 10.0f;

		/// <summary>If you want this component to change smoothly over time, then this allows you to control how quick the changes reach their target value.
		/// -1 = Instantly change.
		/// 1 = Slowly change.
		/// 10 = Quickly change.</summary>
		public float Damping { set { damping = value; } get { return damping; } } [SerializeField] private float damping = 3.0f;
		...
		public float ClampMin { set { clampMin = value; } get { return clampMin; } } [SerializeField] private float clampMin = 1.0f;

		/// <summary>The maximum distance.</summary>
		public float ClampMax { set { clampMax = value; } get { return clampMax; } } [SerializeField] private float clampMax = 100.0f;

		/// <summary>The layers we should collide against.</summary>
		public LayerMask CollisionLayers { set { collisionLayers = value; } get { return collisionLayers; } } [SerializeField] private LayerMask collisionLayers;

		/// <summary>The radius of the collision.</summary>
		public float CollisionRadius { set { collisionRadius = value; } get { return collisionRadius; } } [SerializeField] private float collisionRadius = 0.1f;
...
namespace Virtuesky.Lean.Common.Editor
{
	...
	public class LeanMaintainDistance_Editor : CwEditor
	{
