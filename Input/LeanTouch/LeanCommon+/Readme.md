...
<br>
	...
	<br><br>
	<h1>Versions</h1>
	<div style="overflow:hidden;"><a name="2.0.0"></a><h2>2.0.0</h2><p>Changed folder structure to be inside Plugins/CW/LeanCommon+.<br>Updated inspector code to support third party assets that implement nested inspectors.</p><br><br></div><div style="overflow:hidden;"><a name="1.0.1"></a><h2>1.0.1</h2><p>Fixed <b>LeanSelectedCount</b> not corrently unregistering events.<br>Fixed <b>LeanSelectedCount</b> not updating match in some scenarios.</p><br><br></div><div style="overflow:hidden;"><a name="1.0.0"></a><h2>1.0.0</h2><p>Initial version.</p><br><br></div>
	<br><br>
	<br><br>
	<h1>Components</h1>
	<div style="overflow:hidden;"><a name="LeanActivation"></a><h2>LeanActivation</h2><p>This component lets you know when this component is enabled or disabled.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">UnityEvent</b>
<br>
<span style="">OnEnabled</span>
</h2>
<p>This event will be invoked when this component is enabled.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">UnityEvent</b>
<br>
<span style="">OnDisabled</span>
</h2>
<p>This event will be invoked when this component is disabled.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanChase"></a><h2>LeanChase</h2><p>This component causes the current Transform to chase the specified position.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">Transform</b>
<br>
...
<p>This method will override the Position value based on the specified value.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanCheck"></a><h2>LeanCheck</h2><p>The base class for all components that check the game state to see if a specific condition is met, so then a custom action can be performed.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">bool</b>
<br>
<span style="">Matched</span>
</h2>
<p>Have the conditions of this component been met?</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">UnityEvent</b>
<br>
<span style="">OnMatched</span>
</h2>
<p>If the</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">UnityEvent</b>
<br>
<span style="">OnUnmatched</span>
</h2>
<p>This event will send any previously set values after the specified delay.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanCheckMultiple"></a><h2>LeanCheckMultiple</h2><p>This component checks if the specified <b>LeanCheck</b> components are matched, allowing you to perform a custom action.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">List&lt;LeanCheck&gt;</b>
<br>
<span style="">Targets</span>
</h2>
<p>The components we will check.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">int</b>
<br>
...
<p>The minimum amount of targets that must be matched.</p><p>-1 = Max.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">int</b>
<br>
...
<p>The maximum amount of targets that must be matched.</p><p>-1 = Max.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanCheckValue"></a><h2>LeanCheckValue</h2><p>This component checks if the specified <b>LeanValue</b> component's <b>X</b>, <b>Y</b>, or <b>Z</b> value is within the specified range. If so, it will invoke an event, allowing you to perform a custom action.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">LeanValue</b>
<br>
<span style="">Target</span>
</h2>
<p>The value we will check.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">bool</b>
<br>
...
<p>Check the Z axis?</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanClosestDirection"></a><h2>LeanClosestDirection</h2><p>This component will compare the direction of the current Transform against a list of Transforms, and tell you which is closest.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">Forward</span>
</h2>
<p>This allows you to specify which local direction is considered forward.</p><p>Leave this as the default (0,0,1) if you're not sure.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Transform</b>
<br>
...
<p>This allows you to set which space the <b>Forward</b> direction is in.</p><p>None/null = World space.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
...
<p>This allows you to specify the different direction options we want to check between.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">IntEvent</b>
<br>
<span style="">OnIndexChanged</span>
</h2>
<p>This event will be invoked when the <b>CurrentIndex</b> value changes.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">int</b>
<br>
<span style="">CurrentIndex</span>
</h2>
<p>This stores the current closest <b>Targets</b> index.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
<span style="">UpdateIndex</span>
<br>
<b></b>
</h2>
<p>This method will update the <b>CurrentIndex</b> value now.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanConstrainLocalPosition"></a><h2>LeanConstrainLocalPosition</h2><p>This component allows you to constrain the current <b>transform.localPosition</b> or <b>transform.anchoredPosition3D</b> to the specified min/max values.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">bool</b>
<br>
<span style="">X</span>
</h2>
<p>Clamp the X axis?</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">bool</b>
<br>
...
<p>Clamp the Z axis?</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanConstrainScale"></a><h2>LeanConstrainScale</h2><p>This component will constrain the current transform.localScale to the specified range.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">bool</b>
<br>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanConstrainToOrthographic"></a><h2>LeanConstrainToOrthographic</h2><p>This component will constrain the current <b>transform.position</b> to the specified <b>LeanPlane</b> shape.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">Camera</b>
<br>
<span style="">Camera</span>
</h2>
<p>The camera whose orthographic size will be used.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">LeanPlane</b>
<br>
<span style="">Plane</span>
</h2>
<p>The plane this transform will be constrained to.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanDelayedValue"></a><h2>LeanDelayedValue</h2><p>This component allows you to delay when a value is sent to a component. This is done by first passing the value to this component using one of the <b>SetX/Y/Z</b> methods, and then sending it out after a delay using the <b>OnValueX/Y/Z</b> events.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanDeselected"></a><h2>LeanDeselected</h2><p>This component allows you to detect when any selectable object in the scene has been deselected.</p><br><br></div><div style="overflow:hidden;"><a name="LeanFollow"></a><h2>LeanFollow</h2><p>This component causes the current Transform to follow the specified trail of positions.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
<span style="">Threshold</span>
</h2>
<p>When this object is within this many world space units of the next point, it will be removed.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>The speed of the following in units per seconds.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanManualRescale"></a><h2>LeanManualRescale</h2><p>This component allows you to rescale the current GameObject using events.</p><div style="padding-left:75px;"><br>
<h2>
...
<b style="">Vector3</b>
<br>
<span style="">AxesA</span>
</h2>
<p>The first scale axes, used when calling <b>ScaleA</b> or <b>ScaleAB</b>.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">AxesB</span>
</h2>
<p>The second scale axes, used when calling <b>ScaleB</b> or <b>ScaleAB</b>.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>The scale value is multiplied by this.</p><p>1 = Normal distance.</p><p>2 = Double distance.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>If you enable this then the scale will be multiplied by Time.deltaTime. This allows you to maintain frame rate independent movement.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">DefaultScale</span>
</h2>
<p>If you call the <b>ResetScale</b> method, the scale will be set to this.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
<span style="">ResetScale</span>
<br>
<b></b>
</h2>
<p>This method will reset the scale to the specified <b>DefaultScale</b> value.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
...
<p>This method will cause the scale to immediately snap to its final value.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
<span style="">AddScaleA</span>
<br>
<b>float magnitude</b>
</h2>
<p>This method allows you to scale by <b>AxesA</b>, with the specified multiplier.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
<span style="">AddScaleB</span>
<br>
<b>float magnitude</b>
</h2>
<p>This method allows you to scale by <b>AxesB</b>, with the specified multiplier.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
<span style="">AddScaleAB</span>
<br>
<b>Vector2 magnitude</b>
</h2>
<p>This method allows you to scale by <b>AxesA</b> and <b>AxesB</b>, with the specified multipliers.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
<span style="">AddScale</span>
<br>
<b>Vector3 vector</b>
</h2>
<p>This method allows you to scale by the specified vector in local space.</p>
...
<b style="">bool</b>
<br>
<span style="">RotateAxesToCamera</span>
</h2>
<p>If you want this component to rotate an object relative to a camera, enable this setting.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Camera</b>
<br>
...
<p>The camera used by the <b>RotateAxesToCamera</b> setting.</p><p>None/null = MainCamera.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>If you enable this then the rotation will be multiplied by Time.deltaTime. This allows you to maintain frame rate independent rotation.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanManualTorque"></a><h2>LeanManualTorque</h2><p>This component allows you to add angular force to the current GameObject using events.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">GameObject</b>
<br>
<span style="">Target</span>
</h2>
<p>If your Rigidbody is on a different GameObject, set it here.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>Fixed multiplier for the force.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Space</b>
<br>
...
<b style="">bool</b>
<br>
<span style="">RotateDirectionsToCamera</span>
</h2>
<p>If you want this component to translate an object relative to a camera, enable this setting.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Camera</b>
<br>
...
<b style="">bool</b>
<br>
<span style="">ResetVelocityInUpdate</span>
</h2>
<p>If you want this component to override velocity enable this, otherwise disable this and rely on Rigidbody.drag.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
...
<p>This method allows you to translate along the specified vector in world space.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanManualVelocity"></a><h2>LeanManualVelocity</h2><p>This component allows you to add force to the current GameObject using events.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">GameObject</b>
<br>
<span style="">Target</span>
...
<p>The applied velocity will be multiplied by this.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Space</b>
<br>
...
<p>The second force direction.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">bool</b>
<br>
...
<p>The camera used by the <b>RotateAxesToCamera</b> setting.</p><p>None/null = MainCamera.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanManualVelocity2D"></a><h2>LeanManualVelocity2D</h2><p>This component allows you to add force to the current GameObject using events.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">GameObject</b>
<br>
<span style="">Target</span>
</h2>
<p>If your Rigidbody2D is on a different GameObject, set it here.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">ForceMode2D</b>
<br>
<span style="">Mode</span>
</h2>
<p>The force mode.</p>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanRandomEvents"></a><h2>LeanRandomEvents</h2><p>This component allows you to randomly invoke one of the specified events when you manually call the <b>Invoke</b> method.</p><br><br></div><div style="overflow:hidden;"><a name="LeanRemapValue"></a><h2>LeanRemapValue</h2><p>This component allows you to convert 1, 2, or 3 values from one range to another. For example, an angle in the range of -90..90 could be converted to 0..1. This is done by calling one of the <b>SetX/Y/Z</b> methods, and then sending it out using the <b>OnValueX/Y/Z</b> events.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">OldMin</span>
</h2>
<p>The range of the input values.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">OldMax</span>
</h2>
<p>The range of the input values.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">NewMin</span>
</h2>
<p>The range of the output values.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">NewMax</span>
</h2>
<p>The range of the output values.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
...
<p>Should the values be clamped to the specified ranges?</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">FloatEvent</b>
<br>
...
<b style="">bool</b>
<br>
<span style="">RecordOnStart</span>
</h2>
<p>Call RecordTransform in Start?</p>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanSelected"></a><h2>LeanSelected</h2><p>This component allows you to detect when any selectable object in the scene has been selected.</p><br><br></div><div style="overflow:hidden;"><a name="LeanSelectedCount"></a><h2>LeanSelectedCount</h2><p>This component allows you to detect when a specific amount of selectable objects in the scene have been selected.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">IntEvent</b>
<br>
<span style="">OnCount</span>
...
<p>When the amount of selected objects no longer matches the <b>RequiredCount</b>, this event will be invoked.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanSelectedRatio"></a><h2>LeanSelectedRatio</h2><p>This component allows you to display a number showing the current ratio of selected objects, where a value of 0 means nothing has been selected, and a value of 1 means everything has been selected.</p><p>This can be used with the UI Image Fill, as well as other components.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">bool</b>
<br>
<span style="">Inverse</span>
</h2>
<p>Inverse the ratio value?</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">FloatEvent</b>
<br>
<span style="">OnRatio</span>
</h2>
<p>The formatted string will be output using this event.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">void</b>
<br>
<span style="">UpdateNow</span>
<br>
<b></b>
</h2>
<p>This method will immediately update the ratio.</p>
...
<p>This allows you to control how quickly the target value is reached.</p><p>-1 = Instantly change.</p><p>1 = Slowly change.</p><p>10 = Quickly change.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanThresholdDelta"></a><h2>LeanThresholdDelta</h2><p>This component allows you to accumulate delta changes until they reach a threshold delta, and then output them.</p><p>This is useful for making more precise movements when using inaccurate touch inputs.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
<span style="">Current</span>
</h2>
<p>The current accumulated delta.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>This method allows you to set the <b>Current</b> position.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanValue"></a><h2>LeanValue</h2><p>This component allows you to store 1, 2, or 3 values. This is done by calling one of the <b>SetX/Y/Z</b> or <b>IncX/Y/Z</b> methods, and then sending it out using the <b>OnValueX/Y/Z</b> events.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">FloatEvent</b>
<br>
<span style="">OnValueX</span>
</h2>
<p>When the <b>Current</b> value is set, this event will be invoked with the <b>Current.x</b> value.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">FloatEvent</b>
<br>
...
<p>When the <b>Current</b> value is set, this event will be invoked with the <b>Current.y</b> value.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">FloatEvent</b>
<br>
...
<p>When the <b>Current</b> value is set, this event will be invoked with the <b>Current.z</b> value.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector2Event</b>
<br>
...
<p>When the <b>Current</b> value is set, this event will be invoked with the <b>Current.xy</b> value.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3Event</b>
<br>
...
<p>When the <b>Current</b> value is set, this event will be invoked with the <b>Current.xyz</b> value.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">Vector3</b>
<br>
...
<p>This method will invoke all events with the current value.</p><div class="tip"><strong>NOTE</strong>&emsp; This will automatically be called every time you assign <b>Current</b>, or call any of the Set/Inc methods.</div>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanLoadScene"></a><h2>LeanLoadScene</h2><p>This component allows you to load the specified scene when you manually call the <b>Load</b> method.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">string</b>
<br>
...
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanPongBall"></a><h2>LeanPongBall</h2><p>This script moves the ball left or right and resets it if it goes out of bounds.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
<span style="">StartSpeed</span>
</h2>
<p>Starting horizontal speed of the ball.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>Starting vertical speed of the ball.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
...
<p>The acceleration per second.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
<b style="">float</b>
<br>
<span style="">Bounds</span>
</h2>
<p>If the ball goes this many units from the center, it will reset.</p>
</div><br><br><br></div><div style="overflow:hidden;"><a name="LeanSelectedString"></a><h2>LeanSelectedString</h2><p>This component allows you to display text showing the currently selected object count.</p><div style="padding-left:75px;"><br>
<h2>
<b style="">string</b>
<br>
<span style="">Format</span>
</h2>
<p>The format of the string.</p><p>{0} = The amount of objects that can be selected.</p><p>{1} = The amount of selected objects.</p><p>{2} = The remaining objects to be selected.</p><p>{3} = The percentage of selected objects.</p><p>{4} = The percentage of objects remaining to be selected.</p>
</div><br><div style="padding-left:75px;"><br>
<h2>
...
<p>This method will immediately update the string and output it.</p>
</div><br><br><br></div>
</div>
<div style="position: absolute; width: 310px; left: 0px; right: 0px; top: 20px; bottom: 20px; overflow-y: scroll; padding: 20px;">
	...
	<p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#2.0.0">2.0.0</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#1.0.1">1.0.1</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#1.0.0">1.0.0</a></p>
	<br><br>
	<h2 style="padding-bottom: 5px;">Components</h2>
	<p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanActivation">LeanActivation</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanChase">LeanChase</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanChaseRigidbody">LeanChaseRigidbody</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanChaseRigidbody2D">LeanChaseRigidbody2D</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanCheck">LeanCheck</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanCheckMultiple">LeanCheckMultiple</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanCheckValue">LeanCheckValue</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanClosestDirection">LeanClosestDirection</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainLocalPosition">LeanConstrainLocalPosition</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainScale">LeanConstrainScale</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainToAxis">LeanConstrainToAxis</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainToBox">LeanConstrainToBox</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainToCollider">LeanConstrainToCollider</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainToColliders">LeanConstrainToColliders</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainToDirection">LeanConstrainToDirection</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanConstrainToOrthographic">LeanConstrainToOrthographic</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanDelayedValue">LeanDelayedValue</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanDeselected">LeanDeselected</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanFollow">LeanFollow</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanMaintainDistance">LeanMaintainDistance</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualRescale">LeanManualRescale</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualRotate">LeanManualRotate</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualTorque">LeanManualTorque</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualTranslate">LeanManualTranslate</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualTranslateRigidbody">LeanManualTranslateRigidbody</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualTranslateRigidbody2D">LeanManualTranslateRigidbody2D</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualVelocity">LeanManualVelocity</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanManualVelocity2D">LeanManualVelocity2D</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanOrbit">LeanOrbit</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanPitchYaw">LeanPitchYaw</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanPitchYawAutoRotate">LeanPitchYawAutoRotate</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanRandomEvents">LeanRandomEvents</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanRemapValue">LeanRemapValue</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanRevertTransform">LeanRevertTransform</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanRotateToPosition">LeanRotateToPosition</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanRotateToRigidbody2D">LeanRotateToRigidbody2D</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSelectableCount">LeanSelectableCount</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSelected">LeanSelected</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSelectedCount">LeanSelectedCount</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSelectedRatio">LeanSelectedRatio</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSmoothedValue">LeanSmoothedValue</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSpawnBetween">LeanSpawnBetween</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSwap">LeanSwap</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanThresholdDelta">LeanThresholdDelta</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanThresholdPosition">LeanThresholdPosition</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanValue">LeanValue</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanLoadScene">LeanLoadScene</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanPongBall">LeanPongBall</a></p><p style="margin: 2px; padding-left: 10px; text-indent: -10px;"><a href="#LeanSelectedString">LeanSelectedString</a></p>
	<br><br>
</div>
